(function () {
    ...
    app.factory("formulateDataValues", ["$http", "umbRequestHelper", "formulateVars", "formulateServer", function ($http, umbRequestHelper, formulateVars,
        formulateServer) {
    ...
    function getGetDataValueInfo(services) {
        return function (id) {
            ...
            return services.formulateServer.get(url, params, callbackOptions);
        };
    }
