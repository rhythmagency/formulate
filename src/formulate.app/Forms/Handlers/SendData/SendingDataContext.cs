namespace formulate.app.Forms.Handlers.SendData
{
    ...
    public class SendingDataContext
    {
        ...
        /// <summary>
        /// Gets or sets the configuration for the Send Data handler. This includes things like the URL the
        /// request is being sent to.
        /// </summary>
        public SendDataConfiguration Configuration { get; set; }

        /// <summary>
        /// Gets or sets the initialized web request. This already contains the URL and a few extra request
        ...
        /// <summary>
        /// Gets or sets the data to be sent with the web request. For any method not sending the data in
